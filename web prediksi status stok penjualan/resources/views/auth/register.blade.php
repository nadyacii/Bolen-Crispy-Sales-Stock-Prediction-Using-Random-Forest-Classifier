    ...
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-white">
        <div class="max-w-md w-full px-6 py-12">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600">Mulai prediksi penjualan dengan Roti Bolen AI</p>
            </div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            ...
                            <input id="name" class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                                   type="text"
                                   name="name"
                                   value="{{ old('name') }}"
                                   required
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 13a5 5 0 100-10 5 5 0 000 10z" />
                                </svg>
                            </div>
                            <input id="username" class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                                   type="text"
                                   name="username"
                                   value="{{ old('username') }}"
                                   required
